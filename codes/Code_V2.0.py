...
video_path,csv_file,input_timecode01,input_timecode02,csv_file_timeline=Console_execution.interface()

Test_timeline.creation_timeline(csv_file_timeline)

new_csv,new_video=Reduction_video.reduction(video_path,csv_file,input_timecode01,input_timecode02)
